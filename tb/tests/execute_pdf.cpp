...
//increased this to 2 million so we have time to watch plotting
//after the 1.2 million fast-forward
#define PDF_SIM_CYCLES 2000000 
// gaussian 
#define FAST_FORWARD_THRESHOLD 123500
//noisy #define FAST_FORWARD_THRESHOLD 204700
//triangle: work in progress #define FAST_FORWARD_THRESHOLD 300000
...
public:
    ...
    void initSimulation() {
        ...
        //note: i removed vbdOpen() from here. 
        //we will open it dynamically inside the simulation loop later.
